...
//   Runtime palette: black, burnt orange, deep orange, vivid orange.
...
void main() {
  ...
  if (u_cursorPresence > 0.001 && u_cursorEffect > 3.5)
    col += (vec3(0.18, 0.055, 0.01) + col * 0.12)
      * cursorMask * u_cursorStrength;
  if (u_grain > 0.0001)
    col += vec3(1.0, 0.32, 0.06) * (grainHash(
